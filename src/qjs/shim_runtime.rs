...
//! Real, behaviour-bearing impls live in the `fam_*` modules; this file is for
...
/// Register a process-wide fatal error handler. QuickJS has no equivalent
/// callback surface; we accept and ignore it (errors surface via the normal
/// exception path).
#[unsafe(no_mangle)]
